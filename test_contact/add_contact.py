...
def test_add_contact(app):
    ...
    app.contact2.create(Contact(userfirstname="Edyta", usermiddlename="EK", userlastname="Karpinska", nick="EiKi", title="Title", company="Python", address="My address", home="Home",
